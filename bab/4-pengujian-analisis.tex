...
%Tabel 4.13
\begin{longtable}{|l|c|c|c|c|}
  \caption{Pengujian Performa Model dengan Pencahayaan 55 Lux}
  \label{tb:lux55} \\
  \hline
  \rowcolor[HTML]{C0C0C0} 
  \textbf{Kelas} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Ketidakberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase\\ Ketidakberhasilan\end{tabular}}} \\ \hline
  ...
  \caption[]{Pengujian Performa Model dengan Pencahayaan 55 Lux \textit{(Lanjutan...)}} \\
  \hline
  \rowcolor[HTML]{C0C0C0} 
  \textbf{Kelas} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Ketidakberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase\\ Ketidakberhasilan\end{tabular}}} \\ \hline
  \endhead
...
%Tabel 4.14
\begin{longtable}{|l|c|c|c|c|}
  \caption{Pengujian Performa Model dengan Pencahayaan 131 Lux}
  \label{tb:lux131} \\
  \hline
  \rowcolor[HTML]{C0C0C0} 
  \textbf{Kelas} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Ketidakberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase\\ Ketidakberhasilan\end{tabular}}} \\ \hline
...
\section{Pengujian Performa Model terhadap Subjek}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.329\linewidth}
      \includegraphics[width=\linewidth]{gambar/4.7/azzam/kanan.png}
      \caption{Pose "Kanan"}
      \label{fig:azzam1}
  \end{subfigure}
  \hfill % adds horizontal space between the figures
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/azzam/kiri.png}
    \caption{Pose "Kiri"}
    \label{fig:azzam2}
  \end{subfigure}
  \vspace{1cm} % adds vertical space between the rows of images
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/azzam/maju.png}
    \caption{Pose "Maju"}
    \label{fig:azzam3}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/azzam/mundur.png}
    \caption{Pose "Mundur"}
    \label{fig:azzam4}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/azzam/stop.png}
    \caption{Pose "Stop"}
    \label{fig:azzam5}
  \end{subfigure}
...
\begin{longtable}{|c|c|c|c|c|}
  ...
  \hline
  \rowcolor[HTML]{C0C0C0} 
  \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Pengujian\end{tabular}}}  & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Ketidakberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase\\ Ketidakberhasilan\end{tabular}}} \\ \hline
  300  & 278                                                                                 & 22                                                                                        & 92.66\%                                                                                   & 7.33\%                                                                                         \\ \hline
\end{longtable}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.329\linewidth}
      \includegraphics[width=\linewidth]{gambar/4.7/dimas/kanan.png}
      \caption{Pose "Kanan"}
      \label{fig:dimas1}
  \end{subfigure}
  \hfill % adds horizontal space between the figures
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/dimas/kiri.png}
    \caption{Pose "Kiri"}
    \label{fig:dimas2}
  \end{subfigure}
  \vspace{1cm} % adds vertical space between the rows of images
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/dimas/maju.png}
    \caption{Pose "Maju"}
    \label{fig:dimas3}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/dimas/mundur.png}
    \caption{Pose "Mundur"}
    \label{fig:dimas4}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/dimas/stop.png}
    \caption{Pose "Stop"}
    \label{fig:dimas5}
  \end{subfigure}
...
\begin{figure}[H]
  \centering
  \begin{subfigure}[b]{0.329\linewidth}
      \includegraphics[width=\linewidth]{gambar/4.7/rani/kanan.png}
      \caption{Pose "Kanan"}
      \label{fig:rani1}
  \end{subfigure}
  \hfill % adds horizontal space between the figures
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/rani/kiri.png}
    \caption{Pose "Kiri"}
    \label{fig:rani2}
  \end{subfigure}
  \vspace{1cm} % adds vertical space between the rows of images
  \begin{subfigure}[b]{0.329\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/rani/maju.png}
    \caption{Pose "Maju"}
    \label{fig:rani3}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/rani/mundur.png}
    \caption{Pose "Mundur"}
    \label{fig:rani4}
  \end{subfigure}
  \begin{subfigure}[b]{0.32\linewidth}
    \includegraphics[width=\linewidth]{gambar/4.7/rani/stop.png}
    \caption{Pose "Stop"}
    \label{fig:rani5}
  \end{subfigure}
...
Namun, jika dilihat secara keseluruhan, model klasifikasi pose mata ini telah terbukti mampu memberikan hasil yang cukup baik terhadap ketiga subjek yang diuji. Hal ini mengindikasikan bahwa model tersebut memiliki kapasitas yang baik dalam beradaptasi dengan variasi individu yang berbeda dan mampu memberikan respons yang akurat dan handal dalam berbagai kondisi.

\section{Pengujian Performa \emph{Frame Per Second} (FPS) pada Sistem Kontrol Kursi Roda}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\linewidth}
    ...
    \begin{tikzpicture}
     \begin{axis}[
      width=8.4cm, % Set the width of the chart
      height=6cm, % Set the height of the chart
      ybar interval,
      enlarge x limits=0, 
      ymax=16, 
      ymin=0, 
      ...
      xticklabel style={rotate=90, font=\fontsize{6}{7.2}\selectfont},
      xlabel={Percobaan},
      ylabel={FPS Laptop},
      ylabel near ticks,
      ylabel style={
    ...
    \addplot +[fill = pink, draw = black] coordinates{ 
        (1, 13.007) (2, 13.293) (3, 10.927) (4, 10.697) (5, 13.125) (6, 13.672)
        (7, 11.709) (8, 13.803) (9, 12.866) (10, 12.687) (11, 12.236) (12, 13.295)
	      (13, 12.297) (14, 13.139) (15, 13.439) (16, 13.644) (17, 13.380) (18, 13.271)
        (19, 12.906) (20, 13.689) (21, 12.937) (22, 12.909) (23,  13.348) (24, 13.959)
        (25, 10.389) (26, 12.073) (27, 11.279) (28, 11.669) (29, 12.948) (30, 13.765) (31,0)
    };
    \end{axis}
  \end{tikzpicture}
  \caption{FPS Kelas "Kanan" pada Laptop}
  \label{fig:fpskananlaptop}
  \end{subfigure}
  \hfill % adds horizontal space between the figures
  \begin{subfigure}[b]{0.48\linewidth}
  \centering
  \begin{tikzpicture}
    \begin{axis}[
      width=8.2cm, % Set the width of the chart
      height=6cm, % Set the height of the chart
      ybar interval,
      enlarge x limits=0, 
      ymax=16, 
    ...
    \addplot +[fill = green, draw = black] coordinates{  
        (1, 10.018) (2, 11.369) (3, 10.043) (4, 7.762) (5, 11.295) (6, 12.177)
        (7, 11.977) (8, 10.231) (9, 10.057) (10, 11.284) (11, 10.222) (12, 10.307)
	      (13, 10.119) (14, 11.097) (15, 9.025) (16, 11.983) (17, 9.974) (18, 11.311)
        (19,  8.927) (20, 11.751) (21, 11.887) (22, 9.864) (23,   11.985) (24, 10.505)
        (25, 9.972) (26, 11.274) (27, 10.540) (28, 10.023) (29, 9.763) (30, 10.257) (31,0)
    };
    \end{axis}
  \end{tikzpicture}
  \caption{FPS Kelas "Kanan" pada NUC}
  \label{fig:fpskanannuc}
  \end{subfigure}
  \caption{Perbandingan Grafik Batang FPS Kelas "Kanan" pada Laptop dan NUC}
  \label{fig:fpskanan}
\end{figure}

Pada Gambar \ref{fig:fpskirilaptop} dan Gambar \ref{fig:fpskirinuc}, perintah "Kiri", FPS rata-rata pada laptop mencapai 12,635, sedangkan pada Intel NUC hanya mencapai 10,617. Perbedaan kinerja FPS ini menunjukkan bahwa laptop mampu memproses gambar lebih cepat dan stabil dibandingkan Intel NUC. Pada perintah "Kiri", kisaran FPS pada laptop berada antara 10,617 hingga 14,280, sementara pada Intel NUC antara 8,554 hingga 13,127. 
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \addplot +[fill = pink, draw = black] coordinates{  
          (1, 10.819) (2, 12.150) (3, 13.880) (4, 14.280) (5, 10.916) (6,  12.748)
          (7,  10.617) (8,  13.403) (9, 12.335) (10, 13.354) (11, 12.110) (12, 13.025)
          (13, 13.230) (14, 14.249) (15, 11.462) (16, 13.121) (17,  12.739) (18, 11.925)
          (19, 12.713) (20, 13.314) (21, 13.879) (22, 11.505) (23,   13.413) (24, 12.483)
          (25, 11.470) (26, 12.808) (27, 12.279) (28, 13.388) (29, 12.619) (30, 12.814) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Kiri" pada Laptop}
    \label{fig:fpskirilaptop}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \begin{tikzpicture}
      ...
      \addplot +[fill = green, draw = black] coordinates{  
          (1, 13.127) (2, 10.089) (3, 11.828) (4, 10.205) (5, 9.879) (6, 8.665)
          (7,  9.901) (8, 11.823) (9, 10.071) (10, 10.061) (11, 10.147) (12, 11.725)
          (13, 12.093) (14, 8.660) (15, 11.752) (16,  8.554) (17, 10.001) (18,  9.930)
          (19, 10.125) (20, 10.047) (21, 11.830) (22, 10.171) (23, 9.846) (24, 10.051)
          (25, 11.838) (26, 10.086) (27, 11.760) (28, 12.355) (29, 9.906) (30, 11.979) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Kiri" pada NUC}
    \label{fig:fpskirinuc}
  \end{subfigure}
  \caption{Perbandingan Grafik Batang FPS Kelas "Kiri" pada Laptop dan NUC}
  \label{fig:fpskiri}
\end{figure}

Selanjutnya, berdasarkan hasil pengujian performa \emph{Frame Per Second} (FPS) dari Gambar \ref{fig:fpsmajulaptop} dan Gambar \ref{fig:fpsmajunuc}, pada perintah "Maju", FPS rata-rata pada laptop adalah 13,078 dengan kisaran antara 11,098 hingga 14,142, sedangkan pada Intel NUC, FPS rata-rata adalah 10,068 dengan kisaran antara 7,558 hingga 12,068 yang menunjukkan bahwa laptop memiliki performa FPS yang lebih tinggi dibandingkan Intel NUC.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \addplot +[fill = pink, draw = black] coordinates{  
          (1, 13.574) (2, 13.792) (3, 11.709) (4, 13.372) (5, 13.923) (6,  13.048)
          (7,  12.818) (8, 11.867) (9, 12.701) (10, 13.710) (11, 13.882) (12, 12.945)
          (13, 12.120) (14, 13.302) (15, 12.778) (16, 13.728) (17,  13.972) (18, 13.437)
          (19, 12.809) (20, 12.971) (21, 12.206) (22, 13.330) (23, 13.263) (24, 14.142)
          (25,  11.098) (26, 12.809) (27, 12.813) (28,  13.392) (29, 13.915) (30, 12.905) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Maju" pada Laptop}
    \label{fig:fpsmajulaptop}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
    \begin{tikzpicture}
      ...
      \addplot +[fill = green, draw = black] coordinates{ 
          (1,9.883) (2,10.030) (3,12.068) (4,11.429) (5,9.969) (6,10.374) (7,10.066) 
          (8,11.375) (9,10.430) (10,10.021) (11,9.565) (12,8.903) (13,11.475) (14,8.879) 
          (15,10.026) (16,8.557) (17,10.014) (18,9.865) (19,10.123) (20,10.102) (21,9.941) 
          (22,7.558) (23,9.849) (24,11.985) (25,9.988) (26,9.782) (27,8.755) (28, 9.944) (29, 10.013) (30, 11.077) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Maju" pada NUC}
    \label{fig:fpsmajunuc}
  \end{subfigure}
  \caption{Perbandingan Grafik Batang FPS Kelas "Maju" pada Laptop dan NUC}
  \label{fig:fpsmaju}
\end{figure}

Sementara itu, pada perintah "Mundur", FPS rata-rata pada laptop mencapai 13,507 dengan kisaran antara 11,100 hingga 14,458, menunjukkan bahwa laptop memiliki performa FPS yang lebih tinggi dibandingkan Intel NUC. Sementara, pada Intel NUC, FPS rata-rata adalah 9,734 dengan kisaran antara 6,661 hingga 12,032 yang menunjukkan bahwa laptop memiliki performa FPS yang lebih tinggi dibandingkan Intel NUC.
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \addplot +[fill = pink, draw = black] coordinates{  
        (1,14.144) (2,14.076) (3,13.874) (4,11.190) (5,13.725) (6,13.693) 
        (7,14.066) (8,14.028) (9,13.852) (10,13.271) (11,13.308) (12,14.076) 
        (13,13.201) (14,14.040) (15,13.606) (16,14.195) (17,13.660) (18,13.265) 
        (19,14.458) (20,13.465) (21,13.505) (22,13.840) (23,13.855) (24,13.223) 
        (25,14.083) (26,13.281) (27,11.100) (28, 13.888) (29, 12.248) (30, 12.984) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Mundur" pada Laptop}
    \label{fig:fpsmundurlaptop}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\textwidth}
    ...
    \begin{tikzpicture}
      ...
      \addplot +[fill = pink, draw = black] coordinates{ 
        (1,13.574) (2,13.792) (3,11.709) (4,13.372) (5,13.923) (6,10.987) (7,10.857) 
        (8,12.701) (9,10.875) (10,10.787) (11,12.945) (12,12.120) (13,13.302) 
        (14,12.778) (15,13.728) (16,13.972) (17,13.437) (18,12.809) (19,12.971) 
        (20,12.206) (21,10.415) (22,13.263) (23,11.098) (24,10.440) (25,13.392) 
        (26,13.915) (27,12.905) (28, 12.813) (29, 12.778) (30, 13.530) (31,0)
      };
      \end{axis}
    \end{tikzpicture}
    \caption{FPS Kelas "Stop" pada Laptop}
    \label{fig:fpsstoplaptop}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\textwidth}
    \centering
...
\begin{longtable}{|l|cc|}
  \caption{Rata-rata \emph{Inference Time} dan \emph{Response Time} untuk Semua Kelas}
  \label{tb:rata2delay} \\
  \hline
  \rowcolor[HTML]{D0D0D0} 
...
\begin{longtable}{|l|cl|c|}
  \caption{Rata-rata Kestabilan Motor pada Semua Kelas}  
  \label{tb:rata2stabil} \\
  \hline
  \rowcolor[HTML]{D0D0D0} 
  \textbf{Kelas} & \multicolumn{2}{c|}{\cellcolor[HTML]{D0D0D0}\textbf{\begin{tabular}[c]{@{}c@{}}Rata-rata \\ Lama Motor Berjalan (s)\end{tabular}}} & \cellcolor[HTML]{D9D9D9}\textbf{Standar Deviasi} \\ \hline
  Kanan          & \multicolumn{2}{c|}{6.013}                                                                                                         & 0.408                                            \\ \hline
  Kiri           & \multicolumn{2}{c|}{6.469}                                                                                                         & 0.371                                            \\ \hline
  Maju           & \multicolumn{2}{c|}{6.532}                                                                                                         & 0.117                                            \\ \hline
  Mundur         & \multicolumn{2}{c|}{6.863}                                                                                                         & 0.156                                            \\ \hline
  Stop           & \multicolumn{2}{c|}{4.933}                                                                                                         & 0.361                                            \\ \hline
\end{longtable}
...
Pada Tabel \ref{tb:notideal} dapat dilihat bahwa hasil pengujian menunjukkan bahwa model klasifikasi pose mata mampu memberikan hasil yang cukup baik pada lingkungan yang tidak ideal. Dari 300 kali pengujian, terdapat 281 keberhasilan dan 19 ketidakberhasilan, dengan persentase keberhasilan sebesar 93,66\% dan persentase ketidakberhasilan sebesar 6,33\%. Hasil ini menunjukkan bahwa model klasifikasi pose mata mampu beradaptasi dengan cukup baik pada lingkungan yang tidak ideal dan memberikan respons yang akurat.

\begin{longtable}{|c|c|c|c|c|}
  \caption{Pengujian pada Lingkungan yang Tidak Ideal}
  \label{tb:notideal} \\
  \hline
  \rowcolor[HTML]{C0C0C0} 
  \multicolumn{1}{|c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Pengujian\end{tabular}}}  & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Jumlah \\ Ketidakberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase \\ Keberhasilan\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}Persentase\\ Ketidakberhasilan\end{tabular}}} \\ \hline
  300  & 289                                                                                  & 11                                                                                        & 96.33\%                                                                                  & 3.66\%                                                                                         \\ \hline
\end{longtable}
...
\begin{figure} [H] \centering
  % Nama dari file gambar yang diinputkan
  \includegraphics[scale=0.23]{gambar/4.7/2.jpg}
  % Keterangan gambar yang diinputkan
